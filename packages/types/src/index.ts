...
export const JT_CLIENT_EVENTS = {
  ...
  JT_SELECT_TARGET: "JT_SELECT_TARGET",
  JT_PICK_CARD:     "JT_PICK_CARD",
  JT_REORDER_HAND:  "JT_REORDER_HAND",
} as const;
...
export const JT_SERVER_EVENTS = {
  ...
  JT_TARGET_SELECTED:  "JT_TARGET_SELECTED",
  JT_SELECT_PLAYER_TIMER_START: "JT_SELECT_PLAYER_TIMER_START",
  JT_PICK_TIMER_START: "JT_PICK_TIMER_START",
  JT_CARD_PICKED:      "JT_CARD_PICKED",
  JT_HAND_UPDATE:      "JT_HAND_UPDATE",
  JT_TURN_UPDATE:      "JT_TURN_UPDATE",
